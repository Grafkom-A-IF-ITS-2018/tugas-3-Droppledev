...
class WebGL {
    ...
    add(object3d) {
        ...
        if (object3d.type === 'obj') {
            ...
            console.log(buffer.textureCoord.numItems);
            ...
            console.log(buffer.color.numItems);
    ...
    render() {
        ...
        for (let a = 0; a < 2; a++) {
            for (let b = 0; b < 2; b++) {
                if (a == 0 && b == 0)
                    this.frameOne(0 * width / 2, 1 * height / 2, width / 2, height / 2);
                if (a == 0 && b == 1)
                    this.frameTwo(1 * width / 2, 1 * height / 2, width / 2, height / 2);
                if (a == 1 && b == 1)
                    this.frameFour(1 * width / 2, 0 * height / 2, width / 2, height / 2);
                if (a == 1 && b == 0)
                    this.frameThree(0 * width / 2, 0 * height / 2, width / 2, height / 2);
            }
        }
    }
}
